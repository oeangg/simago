      ...
      return (
        <div className="relative w-full">
          <input
            ...
            type={!show ? type : "text"}
            className={cn(
              "flex h-9 w-full rounded-md border border-input bg-background px-4 py-1 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50",
              className
            )}
            ref={ref}
            {...props}
