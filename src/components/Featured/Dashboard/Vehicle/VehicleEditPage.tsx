...
export const VehicleEditPage = ({ id }: VehicleEditPageProps) => {
  ...
  const {
    ...
    error,
  } = trpc.Vehicle.getVehicleById.useQuery({ id });
    ...
    <div className="container  max-w-4xl mx-auto  space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Perbarui informasi Kendaraan</p>
        </div>
